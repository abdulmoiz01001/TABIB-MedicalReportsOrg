        ...
        <>
            <div id="cssportal-grid" className=' px-2  border-red-900' >
                ...
                <div id="div1" className='flex flex-col justify-center items-center' >
                    ...
                    <p className='text-[#000000] text-[10px] font-bold'> The Mesomorph </p>
                </div>
                <div id="div2" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Slightly </h1>
                    <p className='text-[#000000] text-[10px] font-bold'> Overweight </p>
                </div>
                <div id="div3" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Overweight </h1>
                </div>
                <div id="div4" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Low Fat  </h1>
                    <p className='text-[#000000] text-[10px] font-bold'> Muscular </p>
                </div>
                <div id="div5" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Athletic </h1>
                    <p className='text-[#000000] text-[10px] font-bold'> Muscular </p>
                </div>
                <div id="div6" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Sanguine </h1>
                    <p className='text-[#000000] text-[10px] font-bold'> The Standard </p>
                </div>
                <div id="div7" className='flex flex-col justify-center items-center' >
                    <h1 className='text-[12px] text-[#00000] font-bold'> Slightly </h1>
                    <p className='text-[#000000] text-[10px] font-bold'> Fat </p>
                </div>
                ...
                <div id="div9" className='flex flex-col justify-center items-center' >
                    ...
                    <p className='text-[#000000] text-[10px] font-bold'> Slim </p>
                </div>
