...
const DashboardSideBarComp = () => {
  ...
  return (
    ...
    >
      ...
      {/* Sidebar */}
      <div
        className={`desktop:h-[50%] large-desktop:h-[50%] py-4 laptop:h-[70%] laptop:w-[100px] tablet:w-[80px] tablet:h-[50%] mobile:w-[60px] mobile:h-[50%] large-desktop:w-[220px] rounded-[15px] absolute top-1/2 -translate-y-1/2 ${
      ...
      >
        <div className="flex w-full justify-center items-center large-desktop:pt-4 mobile:pt-2 desktop:pt-4 flex-col gap-4">
