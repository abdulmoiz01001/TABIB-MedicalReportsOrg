...
const FilterbyDateRange = ({ toggleDropdown, formatDateRange, showCalendar, selectionRange, handleClear, handleSelect }) => {
  ...
  const textClass = 'desktop:text-[15px] desktop:leading-5 mobile:text-[11px] tablet:text-[12px] laptop:leading-4 laptop:text-[0.7rem] select-none large-desktop:text-[2rem] text-black';
