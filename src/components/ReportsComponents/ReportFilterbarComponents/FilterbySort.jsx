...
const FilterbySort = ({ toggleDropdown, selectedSortOption, sortOption, isSortDropdownOpen, sortOptions, handleSortOptionSelect }) => {
  ...
  const containerClass = 'flex w-[12%] large-desktop:h-full mobile:relative relative tablet:relative mobile:w-[98%] tablet:w-[45%] flex-col items-center';
  ...
  const textClass = 'desktop:text-[15px] mobile:text-[11px] tablet:text-[12px] laptop:text-[0.7rem] large-desktop:text-[1.5rem] text-black';
