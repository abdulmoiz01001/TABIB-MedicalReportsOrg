...
const TrendOfHypertensionComp = ({totalCount ,data}) => {
  return (
    ...
    <h1 className='desktop:text-[1rem] laptop:text-[0.7rem] tablet:text-[0.7rem] mobile:text-[0.7rem] font-bold large-desktop:text-[1.5rem] border-blue-900 text-black ' >Monthly Trend of Hypertension</h1>
