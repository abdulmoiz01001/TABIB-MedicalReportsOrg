...
const DashboardStaticsComp = () => {
  ...
  return (
    <div className="desktop:w-full large-desktop:w-full laptop:w-full tablet:w-[100vw] flex flex-row  justify-start items-start h-[94%]">
      {loading || !analyticsData?.success ? (
        ...
        <>
          <div className="desktop:w-[77%] large-desktop:w-[77%] tablet:w-full   flex flex-col   h-full gap-3 laptop:pr-3 desktop:pr-3 tablet:justify-center justify-start items-end large-desktop:pr-4">
            ...
            <div className="desktop:w-[98%]  tablet:h-full tablet:w-full  laptop:w-[98%] mb-2 large-desktop:w-[99%] h-screen flex flex-row justify-center items-start gap-2">
