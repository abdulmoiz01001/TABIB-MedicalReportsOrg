...
const DashboardStaticsComp = () => {
  return (
    <>
    <div className='w-full flex flex-row justify-start items-start mx-4 h-full border-2 border-blue-900' >
      <div className='w-[75%] flex flex-col h-full border-2 border-red-900 ' >
         <div className='w-full flex px-1 justify-evenly items-center h-[20%] border-2 border-red-900' >
         ...
         <div className='w-full flex px-1 flex-row justify-start items-start h-[80%] border-2 border-yellow-300 ' >
           <div className='w-[26%] flex flex-col justify-between items-end h-full border-2 border-red-900' >
            <HypertensionComp />
            <OtherTemperamentIndicesComp />

           </div>
           <div className='w-[36.5%] px-1 flex flex-col justify-start items-start h-full border-2 border-red-900' >
            <NoOfPatientsVsAgeComp />
            <TrendOfHypertensionComp />
            <TemperamentChartComp />
           </div>
           <div className='w-[37.5%] flex flex-col justify-center items-start h-full border-2 border-red-900' >

           </div>
         </div>
      </div>
      <div className='w-[25%] h-full border-2 flex flex-col gap-1 border-green-900' >
