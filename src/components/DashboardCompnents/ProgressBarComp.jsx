    ...
    return (
        <>
            <div className="flex w-full h-[18%] my-1 justify-between items-center">
                <div className="bg-[#F9B9B4] tablet:w-[50px] mobile:h-[40px] mobile:w-[40px] tablet:h-[50px] laptop:w-[50px] laptop:h-[50px] desktop:w-[82px] large-desktop:w-[17%] large-desktop:h-[150px] desktop:h-[80px] flex justify-center items-center rounded-[15px] border border-[#CC0001]">
                ...
                <div className="w-[82%] large-desktop:h-[80%] flex flex-col justify-around items-start px-2">
                    ...
                    <div className="flex justify-between w-full items-center">
                        <span className="desktop:text-[1.2rem] mobile:text-[0.6rem] laptop:text-[0.7rem] tablet:text-[0.7rem] large-desktop:text-[2.2rem] font-semibold text-gray-700">{title}</span>
                        {title === 'SpO2' && (
                            <span className="desktop:text-[1rem] mobile:text-[0.5rem] tablet:text-[0.5rem] laptop:text-[0.7rem] large-desktop:text-[2.2rem] font-semibold text-red-500">{percentage}%</span>
                        )}
                    </div>
