    ...
    return (
        <>
            <div className="flex w-full h-[20%]  justify-between items-center">
                <div className="bg-[#F9B9B4] tablet:w-[50px] mobile:h-[40px] mobile:w-[40px] tablet:h-[50px] laptop:w-[50px] laptop:h-[50px] desktop:w-[62px] large-desktop:w-[90px] large-desktop:h-[90px] desktop:h-[80px] flex justify-center items-center rounded-[15px] border border-[#CC0001]">
                    <img src={imgSrc} alt="logo" className="desktop:w-[50px] large-desktop:w-[50px] desktop:h-[50px] large-desktop:h-[500px]" />
                </div>
                <div className="w-[82%] large-desktop:h-[80%] flex flex-col justify-around items-start px-2">
                    {/* Title Section */}
                    <div className="flex justify-between w-full items-center">
                        <span className="desktop:text-[1.2rem] mobile:text-[0.9rem] laptop:text-[0.9rem] tablet:text-[0.9rem] large-desktop:text-[1.5rem] font-semibold text-gray-700">{title}</span>
                        {title === 'SpO2' && (
                    ...
                    <div className="relative w-full laptop:h-[10px] tablet:h-[8px] mobile:h-[9px] desktop:h-[17px] large-desktop:h-[18px] bg-gray-200 rounded-none overflow-hidden">
                        {/* Progress Bar Fill */}
                      {   rangeValue ? 
                          <div
                    ...
                    {title === 'SpO2' || title === 'Temperature' ? (
                        ...
                        <div className="flex justify-between large-desktop:justify-between w-full desktop:text-sm text-gray-600 mt-1">
                            ...
                            <span className="desktop:text-[0.9rem] laptop:text-[0.6rem] tablet:text-[0.8rem] mobile:text-[0.8rem] large-desktop:text-[1.3rem] text-black">{thiredState}</span>
                        </div>
                    )}
                </div>
            </div>
