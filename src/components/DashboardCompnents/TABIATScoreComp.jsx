    ...
    return (
        <>
            <div className='w-full flex justify-between  items-center h-[20%]  bg-[#FAFAFA] border border-[#CC0001] rounded-[15px] ' >
                <div className='w-[50%] large-desktop:pl-8 mobile:pr-6 h-full flex-col flex  justify-center mobile:items-end  desktop:gap-4  desktop:items-end large-desktop:items-start border-blue-900' >
                    <h1 className=' mobile:text-[0.75rem] tablet:text-[0.7rem] desktop:text-[1rem] laptop:text-[0.7rem] large-desktop:text-[1.5rem] text-start font-bold text-black'>Avg. TABIAT Score </h1>
                    <div className='desktop:w-[80%] mobile:w-[60%] mobile:gap-[4px] large-desktop:w-full  mobile:py-4 flex mobile:justify-end justify-start laptop:gap-4 desktop:gap-5 items-center' >
                ...
                <div className='w-[40%] mobile:w-[50%] mobile:items-start h-full large-desktop:h-[80%] flex-col flex  justify-center items-center  border-blue-900' >
