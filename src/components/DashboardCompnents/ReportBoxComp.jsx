    ...
    <div className=" mobile:w-[48%] mobile:h-[120px] mobile:justify-center tablet:w-[48%] desktop:w-[40%] laptop:w-full   tablet:py-3 laptop:py-1.5 desktop:py-2 large-desktop:py-5 bg-[#FAFAFA] px-2 flex flex-col justify-end items-center  rounded-[15px] h-[90%] border border-[#CC0001]">
      ...
      {data ? <>
        ...
        {data?.male >= 0 && data?.female  >= 0 && (
          <div className="flex justify-between laptop:px-1 mobile:px-2 desktop:gap-7 w-[70%] large-desktop:gap-16  items-center">
        ...
        {/* Total Count */}
        <p className="text-[#CC0001] mobile:text-[2rem] large-desktop:text-[8rem] tablet:text-[2rem] laptop:text-[3rem] desktop:text-[3.2rem] font-bold">{data?.total == undefined ? data : data?.total }</p>
