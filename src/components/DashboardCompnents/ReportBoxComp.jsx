...
const ReportBoxComp = ({ data, title, title2 , count }) => {
  ...
  return (
    <div className="w-[14.5%] tablet:py-3 min-w-[100px] laptop:py-1.5 desktop:py-2 large-desktop:py-5 bg-[#FAFAFA] px-2 flex flex-col justify-end items-center  rounded-[15px] h-[90%] border border-[#CC0001]">
      {/* Title */}
