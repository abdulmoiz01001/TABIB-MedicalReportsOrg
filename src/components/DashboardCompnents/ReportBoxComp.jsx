...
const ReportBoxComp = ({ title, title2 , count, male, female }) => {
  return (
    <div className="w-[14%] bg-[#FAFAFA] px-2 flex flex-col justify-center items-center  rounded-[15px] h-[115px] shadow-[0_4px_4px_3px_#FA6E6E40]">
      {/* Title */}
      <h1 className="text-[#000000] text-[0.938rem] text-center font-bold">{title}</h1>
      <h1 className="text-[#000000] text-[0.938rem] text-center font-bold">{title2}</h1>
