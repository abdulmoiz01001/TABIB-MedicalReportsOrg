    ...
    return (
        <>
            <div className='w-full h-[32.5%] bg-[#FAFAFA] laptop:pt-2 flex flex-col justify-center items-center border border-[#CC0001] rounded-[15px]'>
                <h1 className='desktop:text-[1rem] mobile:py-2 tablet:py-2 laptop:text-[0.7rem] tablet:text-[0.7rem] mobile:text-[0.7rem] font-bold large-desktop:text-[1.5rem] border-blue-900 text-black'>
