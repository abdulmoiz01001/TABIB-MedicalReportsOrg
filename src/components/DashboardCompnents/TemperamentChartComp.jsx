...
const TemperamentChartComp = ({data}) => {
  return (
   ...
   <div className='w-full flex h-[35%] flex-col justify-end items-center  bg-[#FAFAFA]  border border-[#CC0001] rounded-[15px] ' >
    ...
    <div className=' desktop:w-[90%] large-desktop:w-[90%] h-[20%] px-2 flex justify-between items-center' >
      ...
      <h1 className='desktop:text-[1rem] large-desktop:text-[2.2rem] text-center font-bold text-black' >Temperament with Dominant Qualities</h1>
