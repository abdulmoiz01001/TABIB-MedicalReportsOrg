   ...
   <div className='w-full flex h-[35%] flex-col justify-end items-center  bg-[#FAFAFA]  border border-[#CC0001] rounded-[15px] ' >
    ...
    <div className=' desktop:w-[90%] large-desktop:w-[90%] h-[20%] laptop:px-0 laptop:gap-2 px-2 flex justify-between items-center' >
      <div className="flex justify-end gap-1 items-center" >
         ...
         <p className="desktop:text-[1rem] laptop:text-[0.6rem] tablet:text-[0.5rem] mobile:text-[0.5rem] large-desktop:text-[2.2rem] text-black" >Male</p>
        </div> 
      <h1 className='desktop:text-[1rem] laptop:text-[0.7rem] tablet:px-2 mobile:px-2 tablet:text-[0.7rem] mobile:text-[0.7rem] large-desktop:text-[2.2rem] text-center font-bold text-black' >Temperament with Dominant Qualities</h1>
      <div className="flex justify-start gap-1 items-center" >
         <img  src='square.svg' className='desktop:w-4 large-desktop:w-8 desktop:h-4 large-desktop:h-8 ' />
         <p className="desktop:text-[1rem] laptop:text-[0.6rem] tablet:text-[0.5rem] mobile:text-[0.5rem] large-desktop:text-[2.2rem] text-black" >Female</p>
        </div> 
