          ...
          <div className='w-full flex justify-center items-center  border-blue-900' >
            ...
            </div>
            {
              !isLargeDesktop ? <div className='w-[80%] gap-2 h-full  flex flex-col justify-start items-center' >
                ...
                <div className="relative rounded-bl-[100px] rounded-tl-[100px]  w-full laptop:h-[11px]  desktop:h-[17px] large-desktop:h-[30px] bg-gray-200 rounded-none overflow-hidden">
