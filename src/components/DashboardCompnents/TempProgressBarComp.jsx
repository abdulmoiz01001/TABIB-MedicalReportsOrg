  ...
  return (
    <>
      <div className='flex w-full h-[20%] border-red-900   justify-between items-center'>
        ...
        <div className="w-[82%] h-full  flex flex-col justify-between py-4 px-2">
          <h1 className="desktop:text-[1rem] large-desktop:text-[2rem] font-semibold text-gray-700">Temperature</h1>
          <div className='w-full flex justify-center items-center  border-blue-900' >
            <div className='w-[20%]  flex flex-col justify-start items-start' >
              <p className='desktop:text-[0.9rem] desktop:text-[#CC0001] large-desktop:text-[1.5rem]'>97.3 F</p>
              <p className='desktop:text-[0.8rem] desktop:text-[#000000] large-desktop:text-[1.5rem]'>96.8~98.6</p>

            </div>
        {
          !isLargeDesktop ?   <div className='w-[80%] gap-2 h-full  flex flex-col justify-center items-center' > 
           
          <div className="relative rounded-bl-[100px] rounded-tl-[100px]  w-full  desktop:h-[9px] large-desktop:h-[30px] bg-gray-200 rounded-none overflow-hidden">
           ...
           {/* Thermometer Bar */}
           <div className="relative rounded-bl-[100px] rounded-tl-[100px] w-full desktop:h-[9px] large-desktop:h-[30px] bg-gray-200 overflow-hidden">
             <div
               className="h-full bg-red-500 transition-all duration-300 ease-in-out"
               style={{ width: '80%' }}
             ></div>
